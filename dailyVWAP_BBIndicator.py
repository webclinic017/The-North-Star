...
#Webhook Discord Bot
hook = Webhook("https://discordapp.com/api/webhooks/752221291548901377/rCvhjdQ8CtexS9936rQee72QfztznvwUQaZ0MuQt5FilU-WmVgiadqeNEnQMFKAmyoz3")
...
def weekday_candlestick(stock, ohlc_data, closep, openp, VWAP, bbands, Av1, Av2, date, SP, df, fmt='%b %d', freq=50, **kwargs):
    ...
    hook.send("VWAP/Bollinger Band Indicator: " + stock + "  Frequency: Daily", file=discord_pic)
    plt.close(fig)
