...
#     quit()
#Webhook Discord Bot
hook = Webhook("https://discordapp.com/api/webhooks/751301661930291250/WjP4XqjES063LGW5xnjIuLIjmK3VZfe_nzzW-nRxPF66DoMy8po7eRyX_kctYFV8jqbA")
...
def weekday_candlestick(stock, ohlc_data, closep, openp, basp,  Av1, Av2, date, SP, df, fmt='%b %d', freq=50, **kwargs):
    ...
    ax2.bar(ndays[40:], basp['Buy.'][40:], facecolor='#71FA1D')
    ax2.bar(ndays[40:], basp['Sell.'][40:]*-1, facecolor='#FF3431')
    fillcolor = '#00ffe8'
   
    ax2.grid(which='major', axis='y', linestyle='-', alpha=.2)
    ...
    plt.ylabel('Buy/Sell Pressure', color='w')
...
def graphData(stock, MA1, MA2):
    try:
        ...
        weekday_candlestick(stock, newAr, closep, openp, basp, Av1, Av2, date, SP, df, fmt='%b %d', freq=3, width=0.5, colorup='green', colordown='red', alpha=1.0)
