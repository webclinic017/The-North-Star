...
def predictData(stock, days, df):
    ...
    if (float(prediction[4]) > (float(last_row)) + 1):
        output = ("\n\nStock:" + str(stock) + "\nPrior Close:\n" + str(last_row) + "\n\nPrediction in 1 Day: " + 
