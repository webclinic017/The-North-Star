...
#     quit()
#Webhook Discord Bot
hook = Webhook("https://discordapp.com/api/webhooks/786002846230511637/YOyWMNFwMPGGjm1lvARkYEPVu5exJmmYfkvk_21V5WbKDGTGTT7JqRfZRY77pBU5g05t")
...
def weekday_candlestick(stock, ohlc_data, closep, openp, volume, low, high, Av1, Av2, date, SP, df, fmt='%b %d', freq=50, **kwargs):
    ...
    hook.send('Double Outside Day Alert: ' + stock +  '  Frequency: Daily', file=discord_pic)
    plt.close(fig)
