...
#Webhook Discord Bot
hook = Webhook("https://discordapp.com/api/webhooks/749734575797829754/NivVU2zYvKDtQW6Kyt6KGXtLQ1OKPJ7CH_bazhslL_TfxBGn1krefSJW8nGIQJUEvgqK")
...
def weekday_candlestick(stock, ohlc_data, closep, openp, vortex, Av1, Av2, date, SP, df, fmt='%b %d', freq=50, **kwargs):
    ...
    hook.send("Vortex Converging: " + stock + "  Frequency: Daily", file=discord_pic)
    plt.close(fig)
