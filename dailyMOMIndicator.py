...
#     quit()
#Webhook Discord Bot
hook = Webhook("https://discordapp.com/api/webhooks/783876443171323955/c8sHlXc5vWj2ahHDceNAFyn4pnNbQfEihEG-U7WM67Od8DshHGEsQKpNCRqtB-Z0WOAL")
...
def weekday_candlestick(stock, ohlc_data, closep, openp, mom, direction, Av1, Av2, date, SP, df, fmt='%b %d', freq=50, **kwargs):
    ...
    hook.send('Momemtum Swing Alert: ' + stock + '  |  Frequency: Daily' + '\n' + 'Direction: ' + direction, file=discord_pic)
    plt.close(fig)
