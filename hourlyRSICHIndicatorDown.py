...
#Webhook Discord Bot
hook = Webhook("https://discordapp.com/api/webhooks/859075566686568488/b4r5wCy4WlHtCanV4sizEZZbX33Yj0qKu2QnyJEhSZd82dvSrzJOpcC5OO4chckUZnWw")
...
def weekday_candlestick(stock, ohlc_data, chaikin, closep, openp, direction, buyselll, Av1, Av2, date, SP, df, fmt='%b %d', freq=50, **kwargs):
    ...
    ax = plt.subplot2grid(
        (6, 4), (0, 0), rowspan=6, colspan=6, facecolor='#07000d')
    ...
    hook.send("TNS Custom ALERT: " + '**' + stock + '**' + '  |  Frequency: 1 Hour' + '\n' + 'Direction: ' + direction, file=discord_pic)
    plt.close(fig)
