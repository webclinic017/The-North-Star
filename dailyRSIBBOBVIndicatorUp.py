...
#Webhook Discord Bot
hook = Webhook("https://discordapp.com/api/webhooks/787790101840789525/ku9Vr8l1ptqhifVEe7RicJlHeq2ZJNbHgLfClnLd0JL5dsDX5iFJHOG0O38Nvu1KNuHz")
...
def weekday_candlestick(stock, ohlc_data, closep, openp, direction, obv,obvSMA, bbands, Av1, Av2, date, SP, df, fmt='%b %d', freq=50, **kwargs):
    ...
    hook.send("TNS Custom ALERT: " + '**' + stock + '**' + '  |  Frequency: Daily' + '\n' + 'Direction: ' + direction, file=discord_pic)
    plt.close(fig)
