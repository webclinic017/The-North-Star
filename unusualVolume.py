...
#     quit()
#Webhook Discord Bot
hook = Webhook("https://discordapp.com/api/webhooks/784103807863750708/M_VNQJ93SJ9Qrpyyv6mhvVetE-BxnnVeaJhDHx-0LMs_P1upG4oBEmdnav9Y62Y_vTZc")
...
def weekday_candlestick(stock, ohlc_data, closep, openp, volume, Av1, Av2, date, SP, df, fmt='%b %d', freq=50, **kwargs):
    ...
    hook.send('Unusually High Volume detected for Ticker: ' + stock, file=discord_pic)
    plt.close(fig)
